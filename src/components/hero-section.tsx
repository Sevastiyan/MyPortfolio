  ...
  return (
    ...
    >
      ...
      <Button
        ...
        scrollTo='about'
        scrollAnimation='smooth'
        className='absolute bottom-12 left-1/2 transform -translate-x-1/2 animate-bounce p-4 rounded-full hover:bg-primary/10 hover:text-primary transition-all duration-300'
      >
