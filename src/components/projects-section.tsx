...
export function ProjectsSection() {
  ...
  const projects = [
    {
      title: 'Serverless Pose Detection Platform',
      description:
        'Built a real-time posture detection platform using MediaPipe BlazePose and WebRTC for multi-device synchronization between mobile and Tizen TV apps. Implemented serverless Lambda microservices for posture evaluation and live feedback overlays.',
      image: '/placeholder-project-1.jpg',
      technologies: ['MediaPipe', 'WebRTC', 'AWS Lambda', 'React', 'DynamoDB', 'Kinesis'],
      icons: [SiTensorflow, SiAwslambda, SiReact, SiWebrtc],
      category: 'AI/ML',
      status: 'Live',
    ...
    {
      title: 'Research-Grade Gait Analysis Algorithm',
      description:
        'Engineered a multi-sensor fusion algorithm that transforms low-cost smart insoles into field-ready gait labs. Uses quaternion-based gravity compensation, ZUPT, and stance phase detection to deliver spatiotemporal metrics comparable to CAREN gold-standard systems.',
      image: '/placeholder-project-2.jpg',
      technologies: ['Sensor Fusion', 'Kotlin', 'Java', 'Python', 'Android SDK', 'IMU'],
      icons: [SiKotlin, SiAndroid, SiPython],
      category: 'AI/ML',
      status: 'Ongoing',
      location: 'Singapore',
      metrics: cleanMetrics({
    ...
    {
      title: 'IoT Sleep Analytics Infrastructure',
      description:
        'Designed end-to-end cloud backend for IoT sleep enhancement platform with AI bio-signal analysis. Optimized TensorFlow edge inference to cut compute costs by 70% while maintaining accuracy, and built analytics dashboards for personalized sleep recommendations.',
      image: '/placeholder-project-3.jpg',
      technologies: ['AWS', 'TensorFlow', 'Python', 'DynamoDB', 'IoT Core', 'Node.js'],
      icons: [SiAmazon, SiTensorflow, SiPython, SiNodedotjs],
      category: 'Platform',
      status: 'Live',
      location: 'Seoul, South Korea',
      metrics: cleanMetrics({
    ...
    {
      title: 'Hospital Patient Activity Monitoring',
      description:
        'Adapted smart insole technology for Ministry of Health–funded pilot enabling remote patient mobility tracking. Built secure hospital integration with ML models achieving 96% accuracy in activity detection and real-time clinical dashboards.',
      image: '/placeholder-project-4.jpg',
      technologies: ['IoT Sensors', 'Android', 'Java', 'Python', 'ML', 'AES-256', 'MQTT'],
      icons: [SiAndroid, SiPython],
      category: 'Real-Time',
      status: 'Deployed',
      location: 'Singapore',
      metrics: cleanMetrics({
    ...
    },
    {
      ...
      description:
        'Developed real-time incident detection system for industrial environments using IoT sensors and ML models with 98% accuracy. Deployed field-tested fall and hazard detection with minimized false positives and instant alert integration for rapid safety response.',
      image: '/placeholder-project-5.jpg',
      technologies: ['IoT Sensors', 'Python', 'ML', 'Android', 'Java', 'Real-Time Processing'],
      icons: [SiPython, SiAndroid],
      category: 'AI/ML',
      status: 'Deployed',
      location: 'Singapore',
      metrics: cleanMetrics({
